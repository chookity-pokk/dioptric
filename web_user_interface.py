...
from utils.tool_belEt import States
import labrad
import time
import argparse
...
if __name__ == "__main__":
    ...
    parser.add_argument('--center-freq',action='store',type=float,required=True)
    parser.add_argument('--sweep-freq-range',action='store',type=float,required=True)
    parser.add_argument('--sweep-points',action='store',type=int,required=True)
    parser.add_argument('--num-sweeps',action='store',type=int,required=True)
    parser.add_argument('--pulse-duration',action='store',type=int,required=True)
