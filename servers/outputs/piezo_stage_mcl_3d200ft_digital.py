...
### BEGIN NODE INFO
[info]
name = piezo_stage_mcl_3d200ft_digital
version = 1.1
description =
...
########## READ ME ##################
# This file has not been set up yet. It is a copy of the PI piezo digital server
# This git project looks to have started commands to use the MCL piezo ditigal control:
